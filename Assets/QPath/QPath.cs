...
namespace QPath {
    ...
    /// <summary>
    /// 
    ///   Tile[] ourPath = QPath.FindPath( ourWorld, theUnit, statTile, endTile );
    ///   
    ///   theUnit is the object that istrying to path between tiles.  It might have
    ///   special logic based on its movement type and the type of the tiles
    ///   being moved through.
    /// 
    ///   Our tiles need to be able to provide:
    ///     1) List of neighbors
